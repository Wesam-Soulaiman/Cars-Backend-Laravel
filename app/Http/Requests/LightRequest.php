    ...
    public function rules(): array
    {
        ...
        if ($lightId) {
            return [
                ...
                'name_ar' => 'nullable|string|max:255|unique:lights,name_ar,'.$lightId,
            ];
        }

        return [
            'name' => 'required|string|max:255|unique:lights,name',
            'name_ar' => 'required|string|max:255|unique:lights,name_ar',
        ];
    }
